...
public class DExcFornecedor extends javax.swing.JDialog {
    ...
    public DExcFornecedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        preencherFornecedor();
    ...
    private void initComponents() {
        ...
        jCFornecedor.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione um fornecedor" }));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jCFornecedor, javax.swing.GroupLayout.PREFERRED_SIZE, 440, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if (jCFornecedor.getSelectedIndex() > 0) {
            ...
            if (fornecedorDAO.delFornecedor(fornecedor)) {
                limpar();
                jCFornecedor.removeItem(fornecedor.getNome());                
                JOptionPane.showMessageDialog(rootPane, "Fornecedor Excluído!", "SUCESSO", JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(rootPane, "Ação não permitida, Fornecedor em uso.", "ERRO", JOptionPane.ERROR_MESSAGE);
            }
            Conexao.desconectar(conexao);
        } else {
    ...
    private void jCFornecedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCFornecedorActionPerformed
        if (jCFornecedor.getSelectedIndex() == 0) {
            ...
            Connection conexao = Conexao.conectar();
            FornecedorDAO fornecedorDAO = new FornecedorDAO(conexao);
            Fornecedor forn = fornecedorDAO.selecionaFornecedor((String) jCFornecedor.getSelectedItem());
            jLNivel.setText("Nome: " + forn.getNome());
            Conexao.desconectar(conexao);
        }
