...
public class DCadFornecedor extends javax.swing.JDialog {
     ...
     */
    public DCadFornecedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if (jTNome.getText().trim().equalsIgnoreCase("")) {
            JOptionPane.showMessageDialog(rootPane, "Preencha o nome do Fornecedor!", "ATENÇÃO", JOptionPane.WARNING_MESSAGE);
            jTNome.requestFocus();
        } else {
            Connection conexao = Conexao.conectar();
            FornecedorDAO fornecedorDAO = new FornecedorDAO(conexao);
            if (!fornecedorDAO.existeFornecedor(jTNome.getText())) {
                ...
                if (fornecedorDAO.addFornecedor(forn)) {
                    limparMarcas();
                    JOptionPane.showMessageDialog(rootPane, "Fornecedor Cadastrado!", "SUCESSO", JOptionPane.INFORMATION_MESSAGE);
                } else {
