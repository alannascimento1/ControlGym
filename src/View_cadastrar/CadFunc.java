 ...
 *
 */
public class CadFunc extends javax.swing.JDialog {

    private TelaPrincipal telaPrincipal;
    /**
     * Creates new form DCadCliente
     */
    public CadFunc(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (jTnome.getText().trim().equals("")
            ...
            if (!funcionarioDAO.existeFuncionario(jFcpf.getText().trim())) {
                ...
                JOptionPane.showMessageDialog(rootPane, "Funcionario já existente!", "ERRO", JOptionPane.ERROR_MESSAGE);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadFunc.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CadFunc dialog = new CadFunc(new javax.swing.JFrame(), true);
