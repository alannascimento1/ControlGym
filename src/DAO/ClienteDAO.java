...
public class ClienteDAO extends ExecuteSQL {
    ...
    public boolean addCliente(Cliente c) {
        String dados[] = new String[]{
            ...
            c.getEndereco(),
            c.getPlano(),
            Integer.toString(c.getPersonal())
            
        };
        return executar("INSERT INTO tb_cliente (nome_cliente, data_nascimento_cliente, cpf_cliente, telefone_cliente, email_cliente, endereco_cliente, plano_cliente, id_func) VALUES (?,?,?,?,?,?,?,?)", dados);
    }
    ...
    public boolean altCliente(Cliente c) {
        String dados[] = new String[]{
            ...
            String.valueOf(c.getPlano()),
            String.valueOf(c.getPersonal()),
            String.valueOf(c.getCpf()),};
        return executar("UPDATE tb_cliente SET nome_cliente = ?, data_nascimento_cliente = ? , telefone_cliente = ? , email_cliente = ?, endereco_cliente = ?, plano_cliente = ?, id_func  = ?  WHERE cpf_cliente = ?", dados);
    }
